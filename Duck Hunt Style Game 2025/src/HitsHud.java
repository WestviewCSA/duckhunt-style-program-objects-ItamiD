...
public class HitsHud {
    ...
    public HitsHud() {
        ...
        img = getImage("/imgs/Hits Hud element0.png");
    ...
    public HitsHud(int x, int y, int scaleX, int scaleY) {
    	this();
    	this.x 		= x;
    	this.y 		= y;
    	this.scaleX = scaleX;
    ...
    private Image getImage(String path) {
        ...
        try {
            URL imageURL = HitsHud.class.getResource(path);
